...
/* package hchesslib-0.2.0.0 */
#ifndef VERSION_hchesslib
#define VERSION_hchesslib "0.2.0.0"
#endif /* VERSION_hchesslib */
#ifndef MIN_VERSION_hchesslib
#define MIN_VERSION_hchesslib(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_hchesslib */
